...
Public Class cnControlAnimal
    ...
    Public Function Cn_ConsultarHistoricoDestete(ByRef obj As coControlAnimal) As DataSet
        Return cls_at.Cd_ConsultarxFechasUbicacionDs("[w_pa_cons_reporte_destete_por_fechas]", obj)
    End Function
    ...
    'CONSULTAS POR COSTO X KILO CERDO - DETALLADO
    Public Function Cn_CostoxKiloLechonRP12Detallado(ByRef obj As coControlAnimal) As DataSet
        Return cls_at.Cd_ConsultarxIdCampaña("[w_pa_detalle_alimento_lactacion]", obj)
    End Function
    ...
    'REGISTRAR COSTO X KILO CERDO (REPRODUCCION)
