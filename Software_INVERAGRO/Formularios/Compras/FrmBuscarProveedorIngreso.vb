...
Public Class FrmBuscarProveedorIngreso
    ...
    Sub Consultar()
        Try
            dtgListado.DataSource = cn.Cn_ListarProveedoresActivos()
    ...
    Private Sub btnnuevo_proveedor_Click(sender As Object, e As EventArgs) Handles btnnuevo_proveedor.Click
        Try
