...
Public Class FrmSeleccionesNutricionistaGesInsumos
    Private Sub FrmSeleccionesNutricionistaGesInsumos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ListarNutricionista()
    ...
    Private Sub btnAsignar_Click(sender As Object, e As EventArgs) Handles btnAsignar.Click
        Try
            Dim f As New FrmGestionInsumo With {
