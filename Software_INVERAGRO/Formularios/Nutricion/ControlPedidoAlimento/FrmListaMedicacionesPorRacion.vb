...
Public Class FrmListaMedicacionesPorRacion
    ...
    Private Sub FrmListaMedicacionesPorRacion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Consultar()
            ...
            If dtgListado.Rows.Count > 0 Then
                If dtgListado.ActiveRow IsNot Nothing AndAlso e.Cell IsNot Nothing AndAlso e.Cell.Value IsNot DBNull.Value AndAlso e.Cell.Value IsNot Nothing AndAlso e.Cell.Value.ToString().Trim() <> "" Then
                    ...
                    If filaSeleccionada.Band.Index = 0 Then ' Tabla padre
                        ...
                        _frmRegistrarPedidoAlimento.ActualizarMedicacionRacion(idSeleccionado, valorMedicacion, tipo)
                        Me.Close()
