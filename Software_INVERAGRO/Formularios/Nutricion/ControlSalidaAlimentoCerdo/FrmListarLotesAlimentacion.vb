...
Public Class FrmListarLotesAlimentacion
    ...
    Private Sub FrmListarLotesAlimentacion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
        ...
        Try
            If (dtgListado.Rows.Count > 0) Then
                If (dtgListado.ActiveRow.Cells(0).Value.ToString.Length <> 0) Then
                    ...
                    _frmNuevoAlimento.LlenarLoteAlimentacion(idLote, descripcion)
                    Me.Close()
                Else
                    msj_advert(MensajesSistema.mensajesGenerales("SELECCIONE_REGISTRO"))
                End If
