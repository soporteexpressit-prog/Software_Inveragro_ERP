...
Public Class FrmMantArchivoSeguro
    Dim cn As New cnControlSeguro
    Public Property SeguroId As Integer
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        Try
            ...
            If MsgBox("¿Esta Seguro de Registrar Archivo?", MsgBoxStyle.OkCancel, "Aviso") = MsgBoxResult.Ok Then
                ...
                MensajeBgWk = cn.Cn_ActualizarArchivoSeguro(obj)
    ...
    Private Sub FrmMantArchivoSeguroTrabajador_Load(sender As Object, e As EventArgs) Handles MyBase.Load
