...
Public Class FrmCroquisPlantel5
    Dim cn As New cnJaulaCorral
    Dim ds As New DataSet

    Private Sub FrmCroquisPlantel5_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            Consultar()
    ...
    Private Sub BackgroundWorker1_RunWorkerCompleted(sender As Object, e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles BackgroundWorker1.RunWorkerCompleted
        ...
        Else
            Dim contenedores() As FlowLayoutPanel = {Galpon01, Galpon02, Galpon03, Galpon04, Galpon05, Galpon06, Galpon07, Galpon08, Galpon09, Galpon10, Galpon11, Galpon12, Galpon13, Galpon14, Galpon15, Galpon16}
            Dim lblTotalAniGalpon() As Label = {LblTotalAniGalpon1, LblTotalAniGalpon2, LblTotalAniGalpon3, LblTotalAniGalpon4, LblTotalAniGalpon5, LblTotalAniGalpon6, LblTotalAniGalpon7, LblTotalAniGalpon8, LblTotalAniGalpon9, LblTotalAniGalpon10, LblTotalAniGalpon11, LblTotalAniGalpon12, LblTotalAniGalpon13, LblTotalAniGalpon14, LblTotalAniGalpon15, LblTotalAniGalpon16}
            Dim lblTotalCorrGalpon() As Label = {LblTotalCorrGalpon1, LblTotalCorrGalpon2, LblTotalCorrGalpon3, LblTotalCorrGalpon4, LblTotalCorrGalpon5, LblTotalCorrGalpon6, LblTotalCorrGalpon7, LblTotalCorrGalpon8, LblTotalCorrGalpon9, LblTotalCorrGalpon10, LblTotalCorrGalpon11, LblTotalCorrGalpon12, LblTotalCorrGalpon13, LblTotalCorrGalpon14, LblTotalCorrGalpon15, LblTotalCorrGalpon16}
