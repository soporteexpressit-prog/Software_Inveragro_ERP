...
Public Class FrmCroquisPlantel1
    Dim cn As New cnJaulaCorral
    Dim ds As New DataSet
    Private Sub FrmCroquisPlantel1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            'Consultar()
    ...
    Private Sub BackgroundWorker1_RunWorkerCompleted(sender As Object, e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles BackgroundWorker1.RunWorkerCompleted
        ...
        Else
            Dim contenedores() As FlowLayoutPanel = {Galpon01_1, Galpon01_2, Galpon02_1, Galpon02_2, Galpon03_1, Galpon03_2, Galpon04_1, Galpon04_2, Galpon05_1, Galpon05_2, Galpon06, Galpon07}
            Dim lblTotalAniGalpon() As Label = {LblTotalAniGalpon1_1, LblTotalAniGalpon1_2, LblTotalAniGalpon2_1, LblTotalAniGalpon2_2, LblTotalAniGalpon3_1, LblTotalAniGalpon3_2, LblTotalAniGalpon4_1, LblTotalAniGalpon4_2, LblTotalAniGalpon5_1, LblTotalAniGalpon5_2, LblTotalAniGalpon6, LblTotalAniGalpon7}
            Dim lblTotalCorrGalpon() As Label = {LblTotalCorrGalpon1_1, LblTotalCorrGalpon1_2, LblTotalCorrGalpon2_1, LblTotalCorrGalpon2_2, LblTotalCorrGalpon3_1, LblTotalCorrGalpon3_2, LblTotalCorrGalpon4_1, LblTotalCorrGalpon4_2, LblTotalCorrGalpon5_1, LblTotalCorrGalpon5_2, LblTotalCorrGalpon6, LblTotalCorrGalpon7}
            ...
            For i As Integer = 0 To contenedores.Length - 1
                ...
                If i < galpones.Count Then
                    ...
                    labelGalpon.Text = galponSalaNombre ' Nombre en formato "GAL-1 / SALA 1"
                    ...
                    For Each corralFila As DataRow In galpones(galponSalaNombre)
                        ...
                        corralPanel.Size = New Size(90, 40) ' Ajusta el tamaño según tu preferencia
                        ...
                        Dim labelCorral As New Label()
                        labelCorral.Text = corralFila("Corral / Jaula").ToString() & vbCrLf & "Cantidad: " & corralFila("Cantidad Animales").ToString()
                        labelCorral.Dock = DockStyle.Fill
                        labelCorral.TextAlign = ContentAlignment.MiddleCenter
