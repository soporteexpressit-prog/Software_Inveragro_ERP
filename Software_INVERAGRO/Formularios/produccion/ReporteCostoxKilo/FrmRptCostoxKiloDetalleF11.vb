...
Public Class FrmRptCostoxKiloDetalleF11
    Dim cn As New cnControlAnimal
    Dim ds As New DataSet
    Public idDetalle As String
    Public idCampaña As Integer

    Private Sub FrmRptCostoxKiloDetalleF11_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            Consultar()
    ...
    Private Sub BackgroundWorker1_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        Try
            ...
            ds = cn.Cn_CostoxKiloLechonRP17Detallado(obj).Copy
            e.Result = ds
        Catch ex As Exception
            e.Cancel = True
        End Try
    ...
    Private Sub BackgroundWorker1_RunWorkerCompleted(sender As Object, e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles BackgroundWorker1.RunWorkerCompleted
        ...
        Else
            ...
            If IsDBNull(dtResult2.Rows(0)("Costo x Vendido Global (sin plantel)")) Then
                LblTotal.Text = "0"
                LblTotalGlobal.Text = "0"
                LblTotalVendidos.Text = "0"
                LblPrecioKiloPromedio.Text = "0"
                LblTotalPreinicio.Text = "0"
            Else
                Dim total As Decimal = Convert.ToDecimal(dtResult2.Rows(0)("Costo x Vendido Global (sin plantel)"))
                ...
                Dim totalVendidos As Decimal = Convert.ToDecimal(dtResult2.Rows(0)("Total Vendidos (sin plantel)"))
                LblTotalVendidos.Text = Math.Round(totalVendidos, 2).ToString("0.00")
                ...
                Dim totalLacta As Decimal = Convert.ToDecimal(dtResult2.Rows(0)("Total Preinicio (kg)"))
                LblTotalPreinicio.Text = Math.Round(totalLacta, 2).ToString("0.00")
            End If
        End If
    End Sub
