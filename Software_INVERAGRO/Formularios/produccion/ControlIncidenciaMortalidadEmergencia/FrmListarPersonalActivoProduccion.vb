...
Public Class FrmListarPersonalActivoProduccion
    Dim cn As New cnTrabajador
    Private ReadOnly _frmMantPersonalProduccion As FrmMantPersonalProduccion

    Public Sub New(frmMantPersonalProduccion As FrmMantPersonalProduccion)
        InitializeComponent()
        _frmMantPersonalProduccion = frmMantPersonalProduccion
    End Sub

    Private Sub FrmListarPersonalActivoProduccion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            If (dtgListado.Rows.Count > 0) Then
                If (dtgListado.ActiveRow.Cells(0).Value.ToString.Length <> 0) Then
                    ...
                    _frmMantPersonalProduccion.LlenarCamposPersonalProduccion(codigo, numDocumento, datos)
                    Me.Close()
                Else
                    msj_advert(MensajesSistema.mensajesGenerales("SELECCIONE_REGISTRO"))
                End If
