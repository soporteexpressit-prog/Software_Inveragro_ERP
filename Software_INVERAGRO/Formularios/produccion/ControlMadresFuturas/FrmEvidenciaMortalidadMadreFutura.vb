...
Public Class FrmEvidenciaMortalidadMadreFutura
    ...
    Public frmMortalidad As FrmMandarCamalMortalidadMadreFutura
    ...
    Private Sub BtnGuardar_Click(sender As Object, e As EventArgs) Handles BtnGuardar.Click
        Try
            ...
            Else
                ...
                Dim MensajeBgWk As String = cn.Cn_RegistrarMortalidadMadreFutura(obj)
