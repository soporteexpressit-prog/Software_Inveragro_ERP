...
Public Class FrmListarJaulaCorralMf
    Dim cn As New cnJaulaCorral
    Public idGalpon As Integer
    Public tipo As String
    Private ReadOnly _frmCodificarMasivo As FrmCodificarMasivo

    Public Sub New(frmCodificarMasivo As FrmCodificarMasivo)
        InitializeComponent()
        _frmCodificarMasivo = frmCodificarMasivo
    End Sub

    Private Sub FrmListarJaulaCorralMf_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            If dtgListado IsNot Nothing AndAlso dtgListado.Rows.Count > 0 Then
                ...
                If activeRow IsNot Nothing Then
                    ...
                    If Not String.IsNullOrEmpty(codigo) AndAlso Not String.IsNullOrEmpty(descripcion) AndAlso Not String.IsNullOrEmpty(sala) Then
                        _frmCodificarMasivo.LlenarCamposJaulaCorral(codigo, descripcion, sala)
                        Me.Close()
                    End If
                Else
