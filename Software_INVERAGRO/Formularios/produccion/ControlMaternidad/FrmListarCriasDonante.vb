...
Public Class FrmListarCriasDonante
    ...
    Private Sub FrmListarCriasDonante_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub BtnAceptar_Click(sender As Object, e As EventArgs) Handles BtnAceptar.Click
        If SelectedIds.Count > 0 Then
            ...
            Dim numeroTotalCrias As Integer = If(SelectedIds.Count = 0, 0, SelectedIds.Count)
            Dim consultarVacia As String = ""

            If SelectedIds.Count = dtgListado.Rows.Count Then
                consultarVacia = "SI"
            Else
                consultarVacia = "NO"
            End If

            _frmRegistrarNodriza.GuardarSeleccionCrias(selectedIdsCriasString, numeroTotalCrias, consultarVacia)
            Me.Close()
        Else
            msj_advert(MensajesSistema.mensajesGenerales("SELECCIONE_REGISTRO"))
        End If
