...
Public Class FrmListarCerdasCambiarLote
    ...
    Private Sub FrmListarCerdasCambiarLote_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
        ...
        Try
            If (dtgListado.Rows.Count > 0) Then
                If (dtgListado.ActiveRow.Cells(0).Value.ToString.Length <> 0) Then
                    ...
                    _frmCambiarLote.LlenarCamposCerda(idAnimal, codigo)
                    Me.Close()
                Else
