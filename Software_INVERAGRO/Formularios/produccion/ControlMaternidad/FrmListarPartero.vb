...
Public Class FrmListarPartero
    ...
    Private Sub FrmListarPartero_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            If (dtgListado.Rows.Count > 0) Then
                If (dtgListado.ActiveRow.Cells(0).Value.ToString.Length <> 0) Then
                    ...
                    _frmRegParto.LlenarCamposPartero(codigo, numDocumento, datos)
                    Me.Close()
                Else
                    msj_advert(MensajesSistema.mensajesGenerales("SELECCIONE_REGISTRO"))
                End If
