...
Public Class FrmReporteCondicionCorporalMaternidadGestacion
    Dim cn As New cnControlAnimal
    Public idUbicacion As Integer
    Public tipoControl As String
    Dim tbtmp As New DataTable

    Private Sub FrmReporteCondicionCorporalMaternidadGestacion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            Inicializar()
            Consultar()
    ...
    Private Sub BackgroundWorker1_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        Try
            ...
            tbtmp = cn.Cn_ReporteCondCorporal(obj).Copy
            tbtmp.TableName = "tmp"
            e.Result = tbtmp
        Catch ex As Exception
            e.Cancel = True
    ...
    Sub Colorear()
        If (dtgListado.Rows.Count > 0) Then
            Dim condicion As Integer = 6
            Dim estadoRango As Integer = 7

            If (tipoControl = "SERVICIO") Then
                condicion = 5
                estadoRango = 6
            End If
