...
Public Class FrmListarMaterialGenetico
    ...
    Private Sub FrmListarMaterialGenetico_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
        ...
        Try
            If (dtgListado.Rows.Count > 0) Then
                If (dtgListado.ActiveRow.Cells(0).Value.ToString.Length <> 0) Then
                    ...
                    _frmRegistrarInseminacion.LlenarCamposMaterialGenetico(id, codVerraco, numDosisDisponibles)
                    Me.Close()
                Else
