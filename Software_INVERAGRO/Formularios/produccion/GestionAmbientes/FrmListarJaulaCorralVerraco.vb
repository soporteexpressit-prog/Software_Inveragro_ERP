...
Public Class FrmListarJaulaCorralVerraco
    ...
    Private Sub FrmListarJaulaCorral_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            If dtgListado IsNot Nothing AndAlso dtgListado.Rows.Count > 0 Then
                ...
                If activeRow IsNot Nothing Then
                    ...
                    If Not String.IsNullOrEmpty(codigo) AndAlso Not String.IsNullOrEmpty(descripcion) AndAlso Not String.IsNullOrEmpty(sala) Then
                        _frmMantenimientoVerraco.LlenarCamposJaulaCorral(codigo, descripcion, sala)
                        Me.Close()
                    End If
                Else
