...
Public Class FrmArea
    ...
    Sub Cambio()
        btnNuevoArea.Visible = False
        btnEditarArea.Visible = False
        btnGuardarArea.Visible = True
    ...
    Sub Cancelar()
        btnNuevoArea.Visible = True
        btnEditarArea.Visible = True
    ...
    Private Sub btnNuevoArea_Click(sender As Object, e As EventArgs) Handles btnNuevoArea.Click
        Nuevo()
    End Sub

    Private Sub btnEditarArea_Click(sender As Object, e As EventArgs) Handles btnEditarArea.Click
        If (dtgListado.Rows.Count > 0) Then
            If (dtgListado.ActiveRow.Cells(0).Value.ToString.Length <> 0) Then
                _Operacion = 1
                Cambio()
                _CodArea = CInt(dtgListado.DisplayLayout.ActiveRow.Cells(0).Value.ToString)
                txtCodigo.Text = _CodArea.ToString
