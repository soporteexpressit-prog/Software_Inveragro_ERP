...
Public Class FrmListarCerdasGestantes
    Dim cn As New cnControlAnimal
    Dim tbtmp As New DataTable
    Public idPlantel As Integer = 0
    Private ReadOnly _frmRegistrarTestGestacion As FrmRegistrarTestGestacion

    Public Sub New(frmRegistrarTestGestacion As FrmRegistrarTestGestacion)
        InitializeComponent()
        _frmRegistrarTestGestacion = frmRegistrarTestGestacion
    End Sub

    Private Sub FrmListarCerdasGestantes_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub BackgroundWorker1_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        Try
            ...
            tbtmp = cn.Cn_ListarCerdasGestantes(obj).Copy
            tbtmp.TableName = "tmp"
            e.Result = tbtmp
        ...
        Try
            If (DtgListadoCerda.Rows.Count > 0) Then
                If (DtgListadoCerda.ActiveRow.Cells(0).Value.ToString.Length <> 0) Then
                    ...
                    _frmRegistrarTestGestacion.LlenarCamposCerdaGestante(codigo, datos)
                    Me.Close()
                Else
                    msj_advert(MensajesSistema.mensajesGenerales("SELECCIONE_REGISTRO"))
                End If
