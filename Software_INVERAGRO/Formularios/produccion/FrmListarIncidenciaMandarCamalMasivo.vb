...
Public Class FrmListarIncidenciaMandarCamalMasivo
    Dim cn As New cnTipoIncidencia
    Private ReadOnly _frmEnvioCamalMasivo As FrmEnvioCamalMasivo

    Public Sub New(frmEnvioCamalMasivo As FrmEnvioCamalMasivo)
        InitializeComponent()
        _frmEnvioCamalMasivo = frmEnvioCamalMasivo
    End Sub

    Private Sub FrmListarIncidenciaMandarCamalMasivo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
        ...
        Try
            If (dtgListado.Rows.Count > 0) Then
                If (dtgListado.ActiveRow.Cells(0).Value.ToString.Length <> 0) Then
                    ...
                    _frmEnvioCamalMasivo.LlenarCampoMotivoMortalidad(codigo, descripcion)
                    Me.Close()
                Else
