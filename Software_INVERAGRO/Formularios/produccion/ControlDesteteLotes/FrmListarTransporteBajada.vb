...
Public Class FrmListarTransporteBajada
    ...
    Private Sub FrmListarTransporteBajada_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            If (dtgListado.Rows.Count > 0) Then
                If (dtgListado.ActiveRow.Cells(0).Value.ToString.Length <> 0) Then
                    ...
                    _frmRegistrarBajada.LlenarCamposTransporte(id, numPlaca, tipoVehiculo)
                    Me.Close()
                Else
