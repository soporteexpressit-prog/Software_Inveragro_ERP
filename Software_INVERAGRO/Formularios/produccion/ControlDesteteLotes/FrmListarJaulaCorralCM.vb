...
Public Class FrmListarJaulaCorralCM
    Dim cn As New cnJaulaCorral
    Public idGalpon As Integer
    Public tipo As String
    Private ReadOnly _frmCodificarCeladorMeishan As FrmCodificarCeladorMeishan

    Public Sub New(frmCodificarMasivo As FrmCodificarCeladorMeishan)
        InitializeComponent()
        _frmCodificarCeladorMeishan = frmCodificarMasivo
    End Sub

    Private Sub FrmListarJaulaCorralCM_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            If dtgListado IsNot Nothing AndAlso dtgListado.Rows.Count > 0 Then
                ...
                If activeRow IsNot Nothing Then
                    ...
                    If Not String.IsNullOrEmpty(codigo) AndAlso Not String.IsNullOrEmpty(descripcion) AndAlso Not String.IsNullOrEmpty(sala) Then
                        _frmCodificarCeladorMeishan.LlenarCamposJaulaCorral(codigo, descripcion, sala)
                        Me.Close()
                    End If
                Else
