...
Public Class FrmMovimientoAmbienteChanchillas
    ...
    Private Sub FrmMovimientoAmbienteChanchillas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            Inicializar()
            ListarCorralesJaula()
    ...
    Private Sub ListarCorralesJaula()
        Try
            ...
            dtgListado.DataSource = cn.Cn_ConsultarAmbientesxArea(obj)
    ...
    Private Sub BtnGuardar_Click(sender As Object, e As EventArgs) Handles BtnGuardar.Click
        Try
            ...
            Dim MensajeBgWk As String = cnLoteDestete.Cn_RegistrarMovimientoUbicacionxLote(obj)
