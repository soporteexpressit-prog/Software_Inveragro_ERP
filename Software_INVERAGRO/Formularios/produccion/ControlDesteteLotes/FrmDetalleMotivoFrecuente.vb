...
Public Class FrmDetalleMotivoFrecuente
    ...
    Private Sub FrmDetalleMotivoFrecuente_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub BackgroundWorker1_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        Try
            ...
            tbtmp = cn.Cn_ConsultarMotivosMortalidad(obj).Copy
            tbtmp.TableName = "tmp"
            e.Result = tbtmp
        Catch ex As Exception
            e.Cancel = True
