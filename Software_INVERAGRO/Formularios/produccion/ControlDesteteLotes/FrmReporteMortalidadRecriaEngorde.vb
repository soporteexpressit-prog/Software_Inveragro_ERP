...
Public Class FrmReporteMortalidadRecriaEngorde
    Dim cn As New cnControlAnimal
    Dim ds As New DataSet
    Public idUbicacion As Integer = 0
    Private search As Boolean = False

    Private Sub FrmReporteMortalidadRecriaEngorde_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            Inicializar()
            ListarLotes()
            Consultar()
    ...
    Private Sub BackgroundWorker1_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        Try
            ...
            ds = cn.Cn_ConsultarMortalidadRecriaEngorde(obj).Copy
    ...
    Private Sub BackgroundWorker1_RunWorkerCompleted(sender As Object, e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles BackgroundWorker1.RunWorkerCompleted
        ...
        Else
            ...
            If ds.Tables("indicadores").Rows.Count > 0 Then
                ...
                LblDestetadosTotales.Text = fila("TotalDestetados").ToString()
    ...
    Private Sub BtnMotivoFrecuencia_Click(sender As Object, e As EventArgs) Handles BtnMotivoFrecuencia.Click
        Try
            Dim frm As New FrmDetalleMotivoFrecuente With {
