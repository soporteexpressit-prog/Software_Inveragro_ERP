...
Public Class FrmReporteMortalidadPlantelLoteEdad
    Dim cn As New cnControlLoteDestete
    Dim tbtmp As New DataTable
    Public idPlantel As Integer = 0
    Public idLote As Integer = 0

    Private Sub FrmReporteMortalidadLoteEdad_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub BackgroundWorker1_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        Try
            ...
            tbtmp = cn.Cn_ConsultarReporteMortalidadLoteEdad(obj).Copy
            tbtmp.TableName = "tmp"
            e.Result = tbtmp
        Catch ex As Exception
            e.Cancel = True
    ...
    Private Sub BtnExportar_Click(sender As Object, e As EventArgs) Handles BtnExportar.Click
        If (dtgListado.Rows.Count = 0) Then
            ...
            Return
        Else
            clsBasicas.ExportarExcel("REPORTE MORTALIDAD LOTE", dtgListado)
        End If
    End Sub
