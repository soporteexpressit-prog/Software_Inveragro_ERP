...
Public Class FrmControlEmbarcadero
    Dim cn As New cnControlCampanaEmbarque
    Dim ds As New DataSet
    Dim flag As Boolean = False

    Private Sub FrmControlEmbarcadero_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            Inicializar()
            ListarPlanteles()
            Consultar()
    ...
    Private Sub BackgroundWorker1_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        Try
            ...
            ds = cn.Cn_ConsultarHistorialEmbarcadero(obj).Copy
            ds.DataSetName = "tmp"
    ...
    Private Sub BtnExportarControlCerda_Click(sender As Object, e As EventArgs) Handles BtnExportarControlCerdaconembarpro.Click
        Try
            If (dtgListado.Rows.Count = 0) Then
                msj_advert(MensajesSistema.mensajesGenerales("SIN_RESULTADOS"))
                Return
            Else
                clsBasicas.ExportarExcel("REGISTRO DE EMBARCADERO", dtgListado)
            End If
        Catch ex As Exception
            clsBasicas.controlException(Name, ex)
        End Try
    ...
    Private Sub BtnOtrasSalidas_Click(sender As Object, e As EventArgs) Handles BtnOtrasSalidasconembarpro.Click
        Dim activeRow As Infragistics.Win.UltraWinGrid.UltraGridRow = dtgListado.ActiveRow
        If (dtgListado.Rows.Count > 0) Then
            If (activeRow.Cells(0).Value.ToString.Length <> 0) Then
                If activeRow.Band.Index = 0 Then
                    Dim idUbicacion As Integer = activeRow.Cells("idUbicacion").Value
                    Dim idCampaña As Integer = activeRow.Cells("idCampaña").Value
                    Dim valorPlantel As String = activeRow.Cells("Plantel").Value
                    Dim valorCampaña As String = activeRow.Cells("Campaña").Value

                    Dim frm As New FrmOtrasSalidasPlantel With {
                        .idUbicacion = idUbicacion,
                        .idCampaña = idCampaña,
                        .valorPlantel = valorPlantel,
                        .valorCampaña = valorCampaña
                    }
                    frm.ShowDialog()
                Else
