...
Public Class FrmHistoricoRecepcionDespachos
    ...
    Private Sub ConsultarHistoricoRecepcion()
        ...
        ds = cn.Cn_ConsultarDespachoxCodigo(obj).Copy
    ...
    '                    Dim tempFilePath As String = Path.Combine(Path.GetTempPath(), "documento.jpg")
        ...
        Try
            With dtgListado
                If (e.Cell.Column.Key = "Ver PDF") Then
                    ...
                    'Dim idRecepcion As Integer = CInt(.ActiveRow.Cells(0).Value)
                    Dim imagenData As Byte() = cn.Cn_ObtenerArchivoAtencionPedidoVenta(CInt(lblCodigo.Text))
