...
Public Class FrmRequerimientoUsuario
    ...
    Sub ListarTablas()
        Try
            ...
            ds = cn.Cn_ListarTablasMaestrasRequerimientoProductos().Copy
            ds.DataSetName = "tmp"
    ...
    Private Sub TsBtn_Guardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        Try
            ...
            Else
                ...
                obj.checkcampaña = If(cbxcampaña.Checked, 1, 0)
    ...
    Private Sub txtcantidad_KeyPress(sender As Object, e As EventArgs) Handles txtcantidad.KeyPress
