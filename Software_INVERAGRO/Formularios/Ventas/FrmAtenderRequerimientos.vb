...
Public Class FrmAtenderRequerimientos
    ...
    Private Sub TsBtn_Guardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        Try
            ...
            Else
                If MsgBox("¿Esta Seguro de Confirmar la Atención del Requerimiento ?", MsgBoxStyle.OkCancel, "Aviso") = MsgBoxResult.Cancel Then
                    Return
                End If
                ...
                MensajeBgWk = cn.CnAntencionProductos(obj)
    ...
    '                If (dtglistado.Rows(i).Cells(5).Value > 0) Then
    ...
    Function creacion_de_arrary() As String
        ...
        For i As Integer = 0 To dtglistado.Rows.Count - 1
            ...
            If Not String.IsNullOrWhiteSpace(row.Cells(0).Value?.ToString()) Then
                If (dtglistado.Rows(i).Cells(4).Value > 0) Then
