...
Public Class FrmControlPedidosVentas
    ...
    Private Sub BackgroundWorker1_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        Try
            ...
            ds = New DataSet
            ds = cn.Cn_ConsultarPedidosVentas(obj).Copy
        Catch ex As Exception
            e.Cancel = True
        End Try
    End Sub
    ...
    Private Sub btnexportar_Click(sender As Object, e As EventArgs) Handles btnexportarVmopeve.Click
        clsBasicas.ExportarExcel("Lista de Pedidos de Ventas", dtgListado)
    End Sub

    Private Sub btnAnular_Click(sender As Object, e As EventArgs) Handles btnAnularVmopeve.Click
        Try
    ...
    Private Sub btnNuevo_Click(sender As Object, e As EventArgs) Handles btnNuevoVmopeve.Click
    ...
    Private Sub btnconfirmar_facturacion_Click(sender As Object, e As EventArgs) Handles btnconfirmar_facturacionVmopeve.Click
        Try
            Dim activeRow As Infragistics.Win.UltraWinGrid.UltraGridRow = Nothing
    ...
    Private Sub btnhistoricorecepciones_Click_1(sender As Object, e As EventArgs) Handles btnhistoricorecepcionesVmopeve.Click
        Try
    ...
    Private Sub btnRecepcionarVmopeve_ButtonClick(sender As Object, e As EventArgs) Handles btnRecepcionarVmopeve.ButtonClick
        Try
            Dim activeRow As Infragistics.Win.UltraWinGrid.UltraGridRow = Nothing
