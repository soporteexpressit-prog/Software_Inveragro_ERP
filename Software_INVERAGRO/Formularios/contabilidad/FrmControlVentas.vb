...
Public Class FrmControlVentas
    ...
    Private Sub BackgroundWorker1_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        Try
            ...
            ds = New DataSet
            ds = cn.Cn_ConsultarVentas(obj).Copy
        Catch ex As Exception
            e.Cancel = True
        End Try
    End Sub
    ...
    Sub ConsultarArchivo(codigo As Integer)
        ...
        Dim obj As New coVentas
        obj.Codigo = codigo
        cn.Cn_ConsultarArchivoFacturacionVenta(obj)


        Dim pdfData As Byte() = obj.ArchivoRecepcion
        If pdfData IsNot Nothing AndAlso pdfData.Length > 0 Then
            Dim tempFilePath As String = Path.Combine(Path.GetTempPath(), "DocArchivoAdjuntado" & codigo.ToString & ".pdf")
        ...
        Try
            If (e.Cell.Column.Key = "btnver") Then
                If dtgListado.ActiveRow IsNot Nothing Then
                    ConsultarArchivo(dtgListado.ActiveRow.Cells("idordenpedido").Value.ToString)
                End If
            End If
        Catch ex As Exception
            MsgBox(ex.Message)
    ...
    Private Sub dtgListado_InitializeLayout(sender As Object, e As Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs) Handles dtgListado.InitializeLayout
        Try
            ...
            With e.Layout.Bands(0)
                ...
                .Columns("idordenpedido").Hidden = True
            End With
    ...
    Private Sub btnexportar_Click(sender As Object, e As EventArgs) Handles btnexportarctfpv.Click
        clsBasicas.ExportarExcel("Lista de Facturacion de Pedidos de Venta", dtgListado)
    End Sub
    ...
    Private Sub btnNuevo_Click(sender As Object, e As EventArgs) Handles btnNuevoctfpv.Click
        Dim f As New FrmBuscarPedidosVentasPendientesFacturacion
        f.ShowDialog()
        Consultar()
    End Sub
    ...
    Private Sub btnreportecontabilidad_Click(sender As Object, e As EventArgs) Handles btnreportecontabilidadgestionventa.Click
        Try
            ...
            Dim ds As New DataSet
            ds = cn.Cn_ReporteOrdendeFacturaxCodigo(obj).Copy
            ds.DataSetName = "bd"
            Dim StiReport1 As New Stimulsoft.Report.StiReport
            StiReport1.Load(clsBasicas.Ruta_Reporte("Rpt_Factura.mrt"))
            StiReport1.Compile()
