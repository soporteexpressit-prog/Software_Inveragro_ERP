...
Public Class FrmRegistrarSeguroActivo
    Dim cn As New cnControlSeguro
    Public DtDetalle As New DataTable("TempDetActivoAsegurado")
    Public SelectedActivos As New HashSet(Of Integer)
    Dim _CodProveedorSeguro As Integer

    Private Sub FrmRegistrarSeguroActivo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Inicializar()
        ListarTipoSeguro()
    ...
    Sub Inicializar()
        ...
        CargarTablaActivosAsegurados()
    End Sub
    Sub CargarTablaActivosAsegurados()
        DtDetalle = New DataTable("TempDetAsegurado")
        DtDetalle.Columns.Add("codActivo", GetType(Integer))
        DtDetalle.Columns.Add("nroSerie", GetType(String))
    ...
    Private Sub dtgListado_ClickCellButton(sender As Object, e As Infragistics.Win.UltraWinGrid.CellEventArgs) Handles dtgListado.ClickCellButton
        If e.Cell.Column.Key = "btneliminar" Then
            Dim result As DialogResult = MessageBox.Show("¿Está seguro de que desea retirar este Activo?", "Confirmar Eliminación", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
            If result = DialogResult.Yes Then
                ...
                SelectedActivos.Remove(codParticipante)
    ...
    Private Sub dtgListado_InitializeLayout(sender As Object, e As Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs) Handles dtgListado.InitializeLayout
        Try
            With e.Layout.Bands(0)
                ...
                .Columns(0).Width = 70
                .Columns(1).Header.Caption = "N° Serie"
                .Columns(1).Width = 200
    ...
    Private Sub btnNuevo_Click(sender As Object, e As EventArgs) Handles btnNuevo.Click
        Try
            ...
            Else
                ...
                MensajeBgWk = cn.Cn_RegistrarSeguroActivo(obj)
