...
Public Class FrmListarEnfermedadesCerdoHE
    Dim cn As New cnEnfermedad
    Private ReadOnly _frmMantHistoricoEnfermedades As FrmMantHistoricoEnfermedades

    Public Sub New(frmMantHistoricoEnfermedades As FrmMantHistoricoEnfermedades)
        InitializeComponent()
        _frmMantHistoricoEnfermedades = frmMantHistoricoEnfermedades
    End Sub
        ...
        If dtgListado.Rows.Count > 0 Then
            ...
            If activeRow IsNot Nothing AndAlso activeRow.Cells.Count > 0 AndAlso activeRow.Cells(0).Value IsNot Nothing Then
                If activeRow.Cells(0).Value.ToString().Trim().Length > 0 Then
                    ...
                    _frmMantHistoricoEnfermedades.LlenarCamposEnfermedad(codigo, descripcion)
                    Me.Close()
                Else
