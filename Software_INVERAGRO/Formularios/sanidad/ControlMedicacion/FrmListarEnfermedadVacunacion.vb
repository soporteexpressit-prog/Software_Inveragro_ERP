...
Public Class FrmListarEnfermedadVacunacion
    ...
    Private Sub FrmListarEnfermedadVacunacion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
        ...
        If dtgListado.Rows.Count > 0 Then
            ...
            If activeRow IsNot Nothing AndAlso activeRow.Cells.Count > 0 AndAlso activeRow.Cells(0).Value IsNot Nothing Then
                If activeRow.Cells(0).Value.ToString().Trim().Length > 0 Then
                    ...
                    _frmRegistrarVacunacionCerdo.LlenarCamposEnfermedad(codigo, descripcion)
                    Me.Close()
                Else
