...
Public Class FrmListarCerdoVacunacion
    ...
    Private Sub FrmListarCerdoVacunacion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            Consultar()
        ...
        Try
            If (dtgListado.Rows.Count > 0) Then
                If (dtgListado.ActiveRow.Cells(0).Value.ToString.Length <> 0) Then
                    ...
                    _frmRegistrarVacunacionCerdo.LlenarCamposCerdo(codigo, codArete)
                    Me.Close()
                Else
                    msj_advert(MensajesSistema.mensajesGenerales("SELECCIONE_REGISTRO"))
                End If
