...
Public Class cdTipoSeguroPlanilla
    Private con As New cdConexion
    Public Function Cd_Mantenimiento(name As String, obj As coTipoSeguroPlanilla) As String
        ...
        Try
            ...
            With cmd.Parameters
                ...
                .AddWithValue("@porcentaje", SqlDbType.Decimal).Value = obj.Porcentaje
