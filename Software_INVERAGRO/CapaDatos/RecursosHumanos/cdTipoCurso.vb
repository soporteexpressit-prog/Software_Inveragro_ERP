...
Public Class cdTipoCurso
    Private con As New cdConexion
    Public Function Cd_Mantenimiento(name As String, obj As coTipoCurso) As String
        ...
        End Try
    End Function
    Public Function Cd_Consultar(name As String, obj As coTipoCurso) As DataTable
