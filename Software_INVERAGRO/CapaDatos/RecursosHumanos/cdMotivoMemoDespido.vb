...
Public Class cdMotivoMemoDespido
    Private con As New cdConexion

    Public Function Cd_Mantenimiento(name As String, obj As coMotivoMemoDespido) As String
        ...
        Try
            ...
            With cmd.Parameters
                ...
                .AddWithValue("@motivo", SqlDbType.VarChar).Value = obj.Descripcion
                .AddWithValue("@nivel", SqlDbType.VarChar).Value = obj.Grado
    ...
    Public Function Cd_ConsultarPorTipo(name As String, obj As coMotivoMemoDespido) As DataTable
        Dim dt As New DataTable
        Try
            con.Abrir()
            Dim da As New SqlDataAdapter(name, con.con)
