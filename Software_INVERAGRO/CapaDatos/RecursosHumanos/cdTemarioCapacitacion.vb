...
Public Class cdTemarioCapacitacion
    Private con As New cdConexion
    Public Function Cd_Mantenimiento(name As String, obj As coTemarioCapacitacion) As String
        ...
        Try
            ...
            With cmd.Parameters
                ...
                .AddWithValue("@idTemasCapa", SqlDbType.Int).Value = obj.IdTemaCapacitacion
        ...
        End Try
    End Function
    Public Function Cd_Consultar(name As String, obj As coTemarioCapacitacion) As DataTable
        ...
        Try
            ...
            da.SelectCommand.Parameters.AddWithValue("@estado", SqlDbType.VarChar).Value = obj.Estado
            da.SelectCommand.Parameters.AddWithValue("@idTemasCapa", SqlDbType.Int).Value = obj.IdTemaCapacitacion
