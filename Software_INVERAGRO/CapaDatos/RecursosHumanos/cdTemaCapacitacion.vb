...
Public Class cdTemaCapacitacion
    Private con As New cdConexion

    Public Function Cd_Mantenimiento(name As String, obj As coTemaCapacitacion) As String
        ...
        Try
            ...
            With cmd.Parameters
                ...
                .AddWithValue("@idAreaCapa", SqlDbType.Int).Value = obj.IdAreaCapacitadora
