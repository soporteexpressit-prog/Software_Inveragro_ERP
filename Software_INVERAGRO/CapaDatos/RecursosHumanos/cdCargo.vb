...
Public Class cdCargo
    ...
    Public Function Cd_Mantenimiento(name As String, obj As coCargo) As String
        ...
        End Try
    End Function
    Public Function Cd_Consultar(name As String, obj As coCargo) As DataTable
        Dim dt As New DataTable
        Try
            con.Abrir()
            Dim da As New SqlDataAdapter(name, con.con)
            da.SelectCommand.CommandType = 4
            da.SelectCommand.Parameters.AddWithValue("@valor", SqlDbType.VarChar).Value = obj.Descripcion
