...
Public Class cdCategoriaProducto
    ...
    Public Function Cd_Mantenimiento(name As String, obj As coCategoriaProducto) As String
    ...
    Public Function Cd_Consultar(name As String, obj As coCategoriaProducto) As DataTable
