...
Public Class cdUnidadMedida
    Private con As New cdConexion

    Public Function Cd_Mantenimiento(name As String, obj As coUnidadMedida) As String
    ...
    Public Function Cd_Consultar(name As String, obj As coUnidadMedida) As DataTable
    ...
    Public Function Cd_ListarUniMedSanidad(name As String, tipo As String) As DataTable
        Dim dt As New DataTable
        Try
            con.Abrir()
            Dim da As New SqlDataAdapter(name, con.con)
