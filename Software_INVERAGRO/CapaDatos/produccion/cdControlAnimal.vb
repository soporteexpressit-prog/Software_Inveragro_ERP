...
Public Class cdControlAnimal
    ...
    Public Function Cd_RegistrarEnvioCamalLote(name As String, obj As coControlAnimal) As String
        ...
        Try
            ...
            With cmd.Parameters
                ...
                .AddWithValue("@fechaControl", SqlDbType.Date).Value = obj.FechaControl
                .AddWithValue("@peso", SqlDbType.Decimal).Value = obj.Peso
                .AddWithValue("@esEnvioCamalChanchilla", SqlDbType.Int).Value = obj.TipoEnvioCamal
                .Add("@msj", SqlDbType.VarChar, 100).Direction = 2
                .Add("@coderror", SqlDbType.Int).Direction = 2
            End With
            cmd.ExecuteNonQuery()
    ...
    Public Function Cd_ConsultarxFechasUbicacionClasificacionDt(name As String, obj As coControlAnimal) As DataTable
        Dim dt As New DataTable
        Try
            con.Abrir()
            Dim da As New SqlDataAdapter(name, con.con)
    ...
    Public Function Cd_ConsultarxFechasUbicacionDt(name As String, obj As coControlAnimal) As DataTable
        Dim dt As New DataTable
        Try
            con.Abrir()
            Dim da As New SqlDataAdapter(name, con.con)
