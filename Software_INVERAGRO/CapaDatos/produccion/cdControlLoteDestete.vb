...
Public Class cdControlLoteDestete
    ...
    Public Function Cd_CierreLlenadoCampana(name As String, obj As coControlLoteDestete) As String
        Dim mensaje As String
        Dim cmd As New SqlCommand(name, con.con)
        Try
            con.Abrir()
    ...
    Public Function Cd_ReporteCondicionCorporal(name As String, obj As coControlLoteDestete) As DataTable
        Dim dt As New DataTable
        Try
            con.Abrir()
            Dim da As New SqlDataAdapter(name, con.con)
