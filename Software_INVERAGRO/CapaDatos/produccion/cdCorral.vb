...
Public Class cdCorral
    Private con As New cdConexion

    Public Function Cd_Mantenimiento(name As String, obj As coCorral) As String
    ...
    Public Function Cd_Consultar(name As String, obj As coCorral) As DataTable
        ...
        Try
            ...
            da.SelectCommand.Parameters.AddWithValue("@idGalpon", If(obj.IdGalpon.HasValue, CType(obj.IdGalpon.Value, Object), DBNull.Value))
            da.Fill(dt)
        Catch ex As Exception
            Throw ex
        End Try
