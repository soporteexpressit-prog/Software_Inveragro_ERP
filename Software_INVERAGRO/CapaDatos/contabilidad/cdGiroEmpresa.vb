...
Public Class cdGiroEmpresa
    Private con As New cdConexion

    Public Function Cd_Mantenimiento(name As String, obj As coGiroEmpresa) As String
    ...
    Public Function Cd_Consultar(name As String, obj As coGiroEmpresa) As DataTable
