...
Public Class cdMoneda
    ...
    Public Function Cd_Mantenimiento(name As String, obj As coMoneda) As String
        ...
        Try
            ...
            With cmd.Parameters
                ...
                .AddWithValue("@idpreciocompra", SqlDbType.Money).Value = obj.preciocompra
                .AddWithValue("@idprecioventa", SqlDbType.Money).Value = obj.precioventa
    ...
    Public Function Cd_Consultar(name As String, obj As coMoneda) As DataTable
