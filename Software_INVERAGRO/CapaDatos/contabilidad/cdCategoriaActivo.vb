...
Public Class cdCategoriaActivo
    Private con As New cdConexion

    Public Function Cd_Mantenimiento(name As String, obj As coCategoriaActivo) As String
    ...
    Public Function Cd_ListarConTipoActivo(name As String) As DataTable
        Dim dt As New DataTable
        Try
            con.Abrir()
            Dim da As New SqlDataAdapter(name, con.con)
