...
Public Class cdTipoActivo
    Private con As New cdConexion

    Public Function Cd_Mantenimiento(name As String, obj As coTipoActivo) As String
        ...
        Try
            ...
            With cmd.Parameters
                ...
                .AddWithValue("@idCategoriaActivo", SqlDbType.Int).Value = obj.IdCategoriaActivo
    ...
    Public Function Cd_Listar_Tipo_Activo_Por_Categoria(name As String, obj As coTipoActivo) As DataTable
        Dim dt As New DataTable
        Try
            con.Abrir()
            Dim da As New SqlDataAdapter(name, con.con)
            da.SelectCommand.CommandType = 4
            da.SelectCommand.Parameters.AddWithValue("@idCategoriaActivo", SqlDbType.Int).Value = obj.IdCategoriaActivo
            da.Fill(dt)
        Catch ex As Exception
            Throw ex
        End Try
