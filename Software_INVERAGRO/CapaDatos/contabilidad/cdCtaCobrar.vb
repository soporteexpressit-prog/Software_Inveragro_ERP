...
Public Class cdCtaCobrar
    Private con As New cdConexion

    Public Function ConsultarCtasCobrar(name As String, ByRef obj As coCtaCobrar) As DataSet
        ...
        Return dt
    End Function
    Public Function Consultar(name As String, ByRef obj As coCtaCobrar) As DataSet
        Dim dt As New DataSet
        Try
            con.Abrir()
            Dim da As New SqlDataAdapter(name, con.con)
        ...
        Return dt
    End Function
    Public Function ObtenerDatosdeCuentaPagarSFP(name As String, ByRef obj As coCtaCobrar) As DataSet
        Dim dt As New DataSet
        Try
            con.Abrir()
            Dim da As New SqlDataAdapter(name, con.con)
            da.SelectCommand.CommandType = 4
            da.SelectCommand.Parameters.AddWithValue("@idpersona", obj.Id)
            da.Fill(dt)
        Catch ex As Exception
            Throw ex
        End Try
        ...
        Return dt
    End Function
    Public Function ObtenerDatosdeCuentaPagar(name As String, ByRef obj As coCtaCobrar) As DataSet
        Dim dt As New DataSet
        Try
            con.Abrir()
            Dim da As New SqlDataAdapter(name, con.con)
        ...
        Return dt
    End Function
    Public Function Cd_obtenerArchivo(name As String, iddetallecuentapagar As Integer) As (Byte(), Integer)
        Dim pdfData As Byte() = Nothing
        Dim imagenPdf As Integer = 0 ' Variable para el campo imagen_pdf
        Try
            con.Abrir()
            Dim cmd As New SqlCommand(name, con.con)
            cmd.CommandType = CommandType.StoredProcedure
            cmd.Parameters.AddWithValue("@iddetalle", iddetallecuentapagar)
            ...
            If reader.Read() Then
                ...
                If Not reader.IsDBNull(1) Then
                    imagenPdf = reader.GetInt32(1) ' Obtener el valor de imagen_pdf
                End If
            End If
            reader.Close()
        Catch ex As Exception
        ...
        Finally
            con.Salir()
        End Try
        Return (pdfData, imagenPdf)
    End Function


    Public Function Cd_Consultarxid(name As String, obj As coCtaCobrar) As DataTable
    ...
    Public Function Cd_Mantenimiento(name As String, obj As coCtaCobrar) As String
        ...
        Try
            ...
            With cmd.Parameters
                ...
                .AddWithValue("@transexepcional", SqlDbType.Int).Value = obj.transexepcional
                .AddWithValue("@idcuentapagardeuda", SqlDbType.Int).Value = obj.idcuentaabonar
                .AddWithValue("@idcuentasaldofavor", SqlDbType.Int).Value = obj.idcuentasaldofavor
                ...
                End If
                .AddWithValue("@idproveedorreferencia", SqlDbType.Int).Value = obj.Idproveedorreferencia
                .AddWithValue("@idtipoabono", SqlDbType.Int).Value = obj.idtipoabono
                .AddWithValue("@adelantoid", SqlDbType.Int).Value = obj.adelantoid
                .AddWithValue("@saldotomarfavor", SqlDbType.Money).Value = obj.saldotomarfavor
        ...
        End Try
    End Function
    Public Function Cd_RegNuevaCuentaCobrar(name As String, obj As coCtaCobrar) As String
        Dim mensaje As String
        Dim cmd As New SqlCommand(name, con.con)
        Try
            con.Abrir()
    ...
    Public Function Cd_RegPrestamo(name As String, obj As coPrestamo) As String
        ...
        Try
            ...
            With cmd.Parameters
                ...
                .AddWithValue("@importe", SqlDbType.Money).Value = obj.Importe
        ...
        End Try
    End Function
    Public Function Cd_AnularCtaPagar(name As String, obj As coCtaCobrar) As String
        Dim mensaje As String
        Dim cmd As New SqlCommand(name, con.con)
        Try
            con.Abrir()
        ...
        End Try
    End Function
    Public Function Cd_AnularAbonoCtaPagar(name As String, obj As coCtaCobrar) As String
        Dim mensaje As String
        Dim cmd As New SqlCommand(name, con.con)
        Try
            con.Abrir()
        ...
        End Try
    End Function
    Public Function Cd_NuevaCtaPagar(name As String, obj As coCtaCobrar) As String
        Dim mensaje As String
        Dim cmd As New SqlCommand(name, con.con)
        Try
            con.Abrir()
        ...
        End Try
    End Function
    Public Function Cd_NuevaCtaPagarDetalle(name As String, obj As coCtaCobrar) As String
        Dim mensaje As String
        Dim cmd As New SqlCommand(name, con.con)
        Try
            con.Abrir()
            ...
            With cmd.Parameters
                ...
                .AddWithValue("@precio", SqlDbType.Money).Value = obj.Idactivo
    ...
    Public Function cd_actualizar_cliente(name As String, obj As coCtaCobrar) As String
        Dim mensaje As String
        Dim cmd As New SqlCommand(name, con.con)
        Try
            con.Abrir()
            ...
            With cmd.Parameters
                ...
                .AddWithValue("@idregistro", SqlDbType.Int).Value = obj.Idcondicionpago
        ...
        End Try
    End Function
    Public Function Cd_ObtenerArchivoAbono(name As String, ByRef obj As coCtaCobrar) As String
    ...
    Public Function ConsultarResumenCaja(name As String, ByRef obj As coCtaCobrar) As DataSet
        Dim dt As New DataSet
        Try
            con.Abrir()
            Dim da As New SqlDataAdapter(name, con.con)
