...
Public Class cdTipoSeguro
    Private con As New cdConexion

    Public Function Cd_Mantenimiento(name As String, obj As coTipoSeguro) As String
        ...
        Try
            ...
            With cmd.Parameters
                ...
                .AddWithValue("@tipoSeguro", SqlDbType.VarChar).Value = obj.TipoSeguro
