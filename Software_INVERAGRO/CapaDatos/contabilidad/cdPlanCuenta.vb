...
Public Class cdPlanCuenta
    Private con As New cdConexion

    Public Function Cd_Mantenimiento(name As String, obj As coPlanCuenta) As String
        ...
        Try
            ...
            With cmd.Parameters
                ...
                .AddWithValue("@idSuperior", SqlDbType.Int).Value = obj.IdSuperior
                .AddWithValue("@iduser", SqlDbType.Int).Value = obj.Iduser
                .AddWithValue("@tipocalificacion", SqlDbType.VarChar).Value = obj.tipocalificacion
    ...
    Public Function Cd_Consultar(name As String, obj As coPlanCuenta) As DataTable
